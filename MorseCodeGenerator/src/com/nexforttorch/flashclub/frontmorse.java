...
public class frontmorse extends ActionBarActivity  {
	TextView mTextField;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.frontmorse);
		...
		//Animation while activity open
	     overridePendingTransition(R.anim.slide_in, R.anim.slide_out);
	      	...
	      	White = (LinearLayout) findViewById(R.id.white);
	 ...
	 @Override
	    public boolean onOptionsItemSelected(MenuItem item) {
	        ...
	        if (id == R.id.action_settingsok) {
	            ...
	            LayoutInflater inflater = frontmorse.this.getLayoutInflater();
	        				new AlertDialog.Builder(frontmorse.this)
		...
		private void playSound() {
			if (isFlashOn) {
				mp = MediaPlayer.create(frontmorse.this, R.raw.light_switch_off);
			} else {
				mp = MediaPlayer.create(frontmorse.this, R.raw.light_switch_on);
			}
